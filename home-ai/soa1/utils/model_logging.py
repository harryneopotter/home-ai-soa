...
# Restrict permissions on the logs directory and file
try:
...
def log_model_call(
    *,
    ...
    - redact: when True, redact sensitive prompt_text by default (only store hash & truncated preview)
    """
    _ensure_file()
    ...
    if redact:
        # Keep a short preview only and store hash for correlation
    ...
    try:
        ...
        # Fail silently to avoid disrupting model calls
        pass
